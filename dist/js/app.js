...
window.addEventListener('load', function () {
  var upcomingBooksAnimation = gsap__WEBPACK_IMPORTED_MODULE_0__.default.timeline({
    scrollTrigger: {
  ...
  var bestSellerAnimation = gsap__WEBPACK_IMPORTED_MODULE_0__.default.timeline({
    scrollTrigger: {
  ...
  var recentLaunchAnimation = gsap__WEBPACK_IMPORTED_MODULE_0__.default.timeline({
    scrollTrigger: {
  ...
  recentLaunchAnimation.from('.recent-launch-section .recent-launch-text-box', {
    ...
    scale: 0,
    duration: 2,
    ease: 'power3.out' // ease: 'elastic.out(1, 0.3)'
  ...
  var allBooksAnimation = gsap__WEBPACK_IMPORTED_MODULE_0__.default.timeline({
    scrollTrigger: {
...
/* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animations */ "./src/js/animations/index.js");
...
/* harmony import */ var gsap_gsap_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap/gsap-core */ "./node_modules/gsap/gsap-core.js");





gsap_gsap_core__WEBPACK_IMPORTED_MODULE_3__.default.registerPlugin(gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_4__.ScrollToPlugin);
window.addEventListener('load', function () {
  stickyHeaderInit();
  ...
  if (backToTopBtn) {
    ...
    backToTopBtn.addEventListener('click', function () {
      gsap_gsap_core__WEBPACK_IMPORTED_MODULE_3__.default.to(window, {
        scrollTo: {
          y: 0
        },
        duration: 2
  ...
  if (document.querySelector('.hero-section')) {
    ...
    var homepageSlider = (0,tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_2__.tns)({
  ...
  if (true) {
    (0,tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_2__.tns)({
...
function stickyHeaderInit() {
  ...
  var headerMenu = header.querySelector('.header-section');
  window.addEventListener('scroll', function () {
